...
const updatebloodbank = async(req,res)=>{
    const bloodbank_name =req.params.bloodbankname;
    const {A_positive,A_negative,O_positive,O_negative,B_positive,B_negative,AB_positive,AB_negative,kind}= req.body;
    const newbloodbank = await bloodbank.updateOne({bloodbank_name},{"$set":{A_positive,A_negative,O_positive,O_negative,B_positive,B_negative,AB_positive,AB_negative,kind}})
    res.json({massage:"success update",newbloodbank})
}
